...
export declare class TeacherPaymentService {
    ...
    create(createTeacherPaymentDto: CreateTeacherPaymentDto): Promise<{
        message: string;
        payment: {
            teacher: {
                id: string;
    ...
    findAll(page?: number, limit?: number, teacherId?: string, isCanceled?: boolean, startDate?: string, endDate?: string): Promise<{
        message: string;
        payments: {
            id: string;
            totalLessonAmount: number;
    ...
    update(id: string, updateTeacherPaymentDto: UpdateTeacherPaymentDto): Promise<{
        message: string;
        payment: {
            teacher: {
                id: string;
    ...
    cancel(paymentId: string, canceledBy: string, canceledReason: string): Promise<{
        id: string;
        isDeleted: boolean;
        deletedAt: Date | null;
        createdAt: Date;
